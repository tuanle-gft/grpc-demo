...
class Void extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Void', package: const $pb.PackageName(_omitMessageNames ? '' : 'managementservice'), createEmptyInstance: create)
...
class Id extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Id', package: const $pb.PackageName(_omitMessageNames ? '' : 'managementservice'), createEmptyInstance: create)
...
class Employee extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Employee', package: const $pb.PackageName(_omitMessageNames ? '' : 'managementservice'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOS(3, _omitFieldNames ? '' : 'employeeType', protoName: 'employeeType')
    ..aInt64(4, _omitFieldNames ? '' : 'dob')
    ..pc<Certificate>(5, _omitFieldNames ? '' : 'certificates', $pb.PbFieldType.PM, subBuilder: Certificate.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.String get employeeType => $_getSZ(2);
  @$pb.TagNumber(3)
  set employeeType($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasEmployeeType() => $_has(2);
  @$pb.TagNumber(3)
  void clearEmployeeType() => clearField(3);

  @$pb.TagNumber(4)
  $fixnum.Int64 get dob => $_getI64(3);
  @$pb.TagNumber(4)
  set dob($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $core.List<Certificate> get certificates => $_getList(4);
}
...
class Certificate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Certificate', package: const $pb.PackageName(_omitMessageNames ? '' : 'managementservice'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOS(3, _omitFieldNames ? '' : 'grade')
    ..a<$core.double>(4, _omitFieldNames ? '' : 'score', $pb.PbFieldType.OF)
    ..aInt64(5, _omitFieldNames ? '' : 'expiredDate', protoName: 'expiredDate')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $fixnum.Int64 get expiredDate => $_getI64(4);
  @$pb.TagNumber(5)
  set expiredDate($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasExpiredDate() => $_has(4);
  @$pb.TagNumber(5)
  void clearExpiredDate() => clearField(5);
}
